...
// Use these middleware to parse JSON and URL-encoded data
app.use(express.json({ limit: '5mb', extended: true })); // for parsing application/json
...
const contractAddress = '0x5314273c5573046A5263Da9Dae83eC822075f94c';
